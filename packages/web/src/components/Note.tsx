...
export default function Note({ title, description, isPublic, id }: NoteProps) {
  ...
  return (
    <Link
      href={url}
      className="group mt-2 cursor-pointer rounded-md border-[0.5px] border-zinc-500 p-4 shadow shadow-transparent transition-all duration-300 hover:border-zinc-200 hover:shadow-zinc-400"
    >
